...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1341: (t, s) => t.set(s),
      _1342: l => new DataView(new ArrayBuffer(l)),
      ...
      _1390: (handle) => clearInterval(handle),
      _1391: (c) =>
      ...
      _1452: (o, p) => o[p],
      _1455: x0 => x0.random(),
      _1456: (x0,x1) => x0.getRandomValues(x1),
      _1457: () => globalThis.crypto,
...
"while rebuilding ProviderScope",
"building ",
"[#",
"defunct",
"_paragraph",
...
"root",
"new widget to drop off set!",
"_currentWidget",
"_currentSelectedWidget",
"Node Viewer",
"free",
"body",
"appBar",
...
"DQ==",
"\n[2] ",
"zero can not be used as denominator",
"Point(",
"rectangle",
"BoxShape.",
"BorderStyle.",
...
"SYSTEM",
"name expected",
":A-Z_a-zÀ-ÖØ-öø-˿Ͱ-ͽͿ-῿‌-‍⁰-↏Ⰰ-⿯、-퟿豈-﷏ﷰ-�𐀀-󯿿-.0-9·̀-ͯ‿-⁀",
" (case-insensitive)",
" expected",
"\\b",
"\\t",
...
"TooltipTriggerMode.",
"_visible",
"No widget options defined for type: ",
". Please define them before using.",
"englishLike",
"dense",
"tall",
"surface_variant",
...
"drawer",
"ListTileStyle.",
"viewListFadeOnIntervalCurve",
"viewDividerFadeCurve",
...
"fontWeight",
"Color",
"_controlAndExitListener",
"searchBarEntries",
"HQ==",
"Error converting map to color: ",
", map: ",
"assets/screens/test.json",
"Loading GUI...",
"Error loading GUI:",
"Retry",
"No widget loaded",
...
"isometric",
"an orientation of ",
" isn't implemented! please use either orthogonal or isometric!",
"Anchor(",
"topCenter",
"centerLeft",
"centerRight",
...
", ascent: ",
", descent: ",
"TextPainterTextElement(text: ",
"Unknown implementation of TextRenderer: ",
". Please register it ",
...
"_repeat",
"ImageRepeat.",
"Map orientation should be present",
"odd",
"generated",
"FlippedAtlasStatus.",
"generating",
"#with-flips",
"transforms",
"Invalid combination of booleans: ",
"Rectangle (",
") ",
" x ",
"Tileset not found",
...
"gzip",
"zstd",
"zstd is an unsupported compression",
"littleEndian",
"bigEndian",
"_length",
"table",
...
"entity",
"Virtual Guy",
"assets/tiles/Level_2.tmx",
"orientation=\"",
"tilewidth=\"",
"tileheight=\"",
"height: ",
"\\.(png|jpg|jpeg|svg|gif|webp|bmp|wbmp)$",
"_hitboxParent",
"trying to play animation on older checkpoints",
"_container",
...
"\\n    ?at ",
"^<asynchronous suspension>\\n?$",
"Argument [level] must be greater than or equal to 0.",
"riverpod",
"notifier",
"Trying to read an uninitialized value.",
...
"Main Characters/Virtual Guy",
"Unsupported shapes",
"Unsupported intersection detected between: ",
...
"Player: ",
"\nMouse: ",
"\nGrid Mouse Coords isometric: ",
" \nGrid Mouse coords Orthogonal: ",
"easeIn",
"easeOut",
"easeInOut",
"buttonComponent",
...
"Tile at (",
") has GID: ",
"Properties for tile at (",
"):",
"  - ",
"pos: ",
"Highlight position set to: ",
"Selected tile at ",
" on layer ",
"No tile selected.",
"loaded!",
...
"_baseKnobPosition",
"knobRadius",
"PointerMoveEvent(devicePosition: ",
", timestamp: ",
...
"dismissDuration",
"autoDismiss",
"Hello, this is a speech bubble example!",
"_typingTimer",
"Close Dialogue",
"_CardVariant.",
"Next",
...
"_rawYarnScript",
"Cannot run node \"",
"\" because another node is ",
"currently running: \"",
"Node \"",
"\" could not be found",
"Cannot set variable ",
" to a value with type ",
...
"#lastline",
"<<",
">> command cannot be used inside a node",
"startExpression",
"startMarkupTag",
"commands are not allowed on a dialogue line",
"expected end of line",
"hashtag",
"endExpression",
"endMarkupTag",
"unexpected closing markup tag",
"Expected closing tag for [",
"markup tag [",
"] was not closed",
"closeMarkupTag",
"a markup tag name is expected",
"operatorAssign",
"duplicate parameter ",
" in a markup attribute",
"ExpressionType.",
"boolean",
...
"both left and right sides of `%` must be numeric, instead the types are ",
"The divisor of a modulo is not a positive number: ",
"both left and right sides of `-` must be numeric or strings, instead ",
"both left and right sides of `<` must be numeric, instead the types are ",
"both left and right sides of `<=` must be numeric, instead the types ",
"both left and right sides of `>` must be numeric, instead the types ",
"both left and right sides of `>=` must be numeric, instead the types ",
"equality operator between operands of unrelated types ",
"both left and right sides of `/` must be numeric, instead the types are ",
"Division by zero",
"both left and right sides of `&&` must be boolean, instead the types ",
"operatorNot",
...
"operator `not` can only be applied to booleans",
"comma",
"unexpected token",
"Bad return type",
...
"the argument in ",
"() should be numeric",
"function random_range() requires two arguments",
"the first argument should be numeric",
"the second argument should be numeric",
"In random_range(a=",
", b=",
") the upper bound cannot be less ",
"than the lower bound",
"function random() requires no arguments",
"function plural() requires at least ",
" arguments",
"function plural() requires at most ",
...
"Character(",
"person",
"No option selected in a DialogueChoice",
"Invalid option index chosen in a dialogue: ",
...
"<unevaluated>",
"DialogueLine(",
"multiple commands are not allowed on an option line",
"endIndent",
" #disabled",
"Option(",
"commandIf",
"only \"if\" command is allowed for an option",
"the condition in \"if\" should be boolean",
"endCommand",
"unexpected end of file",
"endHeader",
"a node can only have one title",
"node with title \"",
"\" has already been defined",
"node does not have a title",
"SyntaxError: ",
"TypeError: ",
"commandJump",
"commandVisit",
...
"commandElse",
"commandEndif",
"this command is only allowed after an <<if>>",
"Unknown user-defined command <<",
">>",
"Command <<",
">> expects ",
"argument",
...
"Whitespace is required after a quoted argument",
"_argumentString",
"Command(",
"character \"",
"\" was already defined: ",
"at least one character id is required",
"character",
"variable name expected",
"redeclaration of local variable ",
" shadows a global variable with the ",
"same name",
...
"an assignment operator is expected",
" of type ",
...
"operatorPlusAssign",
"<<wait>> command expects a numeric argument",
"<<wait>> command with negative duration: ",
"target of <<jump>> must be a string expression",
"visit",
"elseif",
"only one <<else>> is allowed",
"<<endif>> expected",
"the body of the <<else>> command must be indented",
"expression in an <<",
">> command must be boolean",
"the body of the <<",
">> command must be indented",
"TokenType.",
"Token.",
"('",
"')",
"eof",
"invalid token",
"incomplete node body",
">  at line ",
" column ",
">  ",
"unexpected indentation",
"expected end-of-header marker \"---\"",
"String",
"Number",
"Bool",
"as",
...
"/=",
"%=",
"unexpected end of line while parsing a string",
"$",
"invalid variable name",
"missing markup tag close token \"]\"",
"special character needs to be escaped",
"invalid escape sequence",
"Index inside surrogate pair: ",
"inconsistent indentation",
"an ID or an expression in curly braces expected",
"missing command close token \">>\"",
"command",
"else",
"endif",
"Yes",
...
"The left position of the widget in the stack.",
"The top position of the widget in the stack.",
"The right position of the widget in the stack.",
"The bottom position of the widget in the stack.",
"Alignment.center",
...
"Opacity",
"The color of the card. If not set, white will be used.",
"The margin of the card. If not set, 8.0 will be used.",
"Card",
"crossAxisCount",
...
"Mg==",
"painter",
"NinePatchTexture for ",
" not found in cache. Please create it first.",
"ninepatch_button",
"test_button",
"test_button_2",
"nextIteration",
...
"When setting any colors, a blend mode must be provided.",
"src",
"_layerPaint",
